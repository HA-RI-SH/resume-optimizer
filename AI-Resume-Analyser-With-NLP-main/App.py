...
def run():
    ...
    link = '[©Developed by Harish ](https://www.linkedin.com/in/harish-hari-404abb221/)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'harish' and ad_password == 'harish@26':
                st.success("Welcome Harish !")
                # Display Data
               ...
               # print(values)
                labels = ['Data science', 'Web Development', 'Android App Development','IOS App Development']
                values = plot_data.Predicted_Field.value_counts().values
                print(values)
                ...
                labels = [ 'intermediate level', 'experienced level ']
